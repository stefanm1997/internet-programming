...
public class FlightDTO implements Serializable {
	...
	private FlightScheduleDTO flightSchedules;
	...
	public FlightDTO(int iD, int seats_Number, int start_Location_ID, int end_Location_ID, String description,
			String file, String type, String status, LocationDTO startLocation, LocationDTO endLocation,
			FlightScheduleDTO flightSchedules) {
		super();
		ID = iD;
		Seats_Number = seats_Number;
		Start_Location_ID = start_Location_ID;
	...
	public FlightScheduleDTO getFlightSchedules() {
		return flightSchedules;
	}

	public void setFlightSchedules(FlightScheduleDTO flightSchedules) {
		this.flightSchedules = flightSchedules;
	}
